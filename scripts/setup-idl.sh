...
IDL_INPUT_FILE=target/types/bullistic_candy_machine.ts
PREVIOUS_IDL=target/types/previous_bullistic_candy_machine.ts

IDL_OUTPUT_FILE=src/sdk/idl/BullisticCandyMachine.ts
