...
pub struct InitializeCandyMachine<'info> {
    ...
    /// CHECK: bullistic_authority can be any account and is not written to or read
    bullistic_authority: UncheckedAccount<'info>,
...
pub fn handle_initialize_candy_machine(
    ...
    let mut candy_machine = CandyMachine {
        data,
        bullistic_authority: ctx.accounts.bullistic_authority.key(),
