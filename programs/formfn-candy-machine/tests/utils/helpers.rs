...
use formfn_candy_machine::constants::{CONFIG_ARRAY_START, CONFIG_LINE_SIZE};
use formfn_candy_machine::{CandyError, CandyMachine};
...
use formfn_candy_machine::{
    constants::{FORMFN_CANDY_MACHINE_ERROR_OFFSET, PREFIX as CANDY_PREFIX},
...
pub fn find_candy_creator(candy_machine_key: &Pubkey) -> (Pubkey, u8) {
    ...
    Pubkey::find_program_address(seeds, &formfn_candy_machine::id())
}
...
pub fn get_anchor_error_code_number_from_candy_error(candy_error: CandyError) -> u32 {
    ...
    expected_candy_machine_error_code + ERROR_CODE_OFFSET + FORMFN_CANDY_MACHINE_ERROR_OFFSET
}
