...
pub fn candy_machine_program_test() -> ProgramTest {
    let mut program = ProgramTest::new("formfn_candy_machine", formfn_candy_machine::id(), None);
...
pub async fn initialize_candy_machine(
    ...
    let create_ix = system_instruction::create_account(
        ...
        &formfn_candy_machine::id(),
    );

    let mut accounts = formfn_candy_machine::accounts::InitializeCandyMachine {
        candy_machine: candy_account.pubkey(),
        treasury_wallet: *treasury_wallet,
        formfn_authority: payer.pubkey(),
    ...
    let data =
        formfn_candy_machine::instruction::InitializeCandyMachine { data: candy_data }.data();
...
pub async fn update_candy_machine(
    ...
    formfn_authority: &Keypair,
    data: CandyMachineData,
    treasury_wallet: &Pubkey,
    treasury_mint: Option<Pubkey>,
) -> SolanaProgramTestResult {
    let mut accounts = formfn_candy_machine::accounts::UpdateCandyMachine {
        candy_machine: *candy_machine,
        formfn_authority: formfn_authority.pubkey(),
        treasury_wallet: *treasury_wallet,
    }
    .to_account_metas(None);
    ...
    let data = formfn_candy_machine::instruction::UpdateCandyMachine { data }.data();
...
pub async fn append_merkle_allowlist_roots(
    ...
    let data =
        formfn_candy_machine::instruction::AppendMerkleAllowlistRoots { roots_to_append }.data();
...
pub async fn clear_merkle_allowlist_roots(
    ...
    let accounts = formfn_candy_machine::accounts::ClearMerkleAllowlistRoots {
        formfn_authority: formfn_authority.pubkey(),
        candy_machine: *candy_machine,
    }
    .to_account_metas(None);

    let data = formfn_candy_machine::instruction::ClearMerkleAllowlistRoots {}.data();
...
pub async fn add_config_lines(
    ...
    let accounts = formfn_candy_machine::accounts::AddConfigLines {
        candy_machine: *candy_machine,
        formfn_authority: formfn_authority.pubkey(),
    }
    .to_account_metas(None);

    let data = formfn_candy_machine::instruction::AddConfigLines {
        index,
        config_lines,
    }
    .data();
...
pub async fn set_collection(
    ...
    let accounts = formfn_candy_machine::accounts::SetCollection {
        candy_machine: *candy_machine,
        formfn_authority: formfn_authority.pubkey(),
        creator_authority: creator_authority.pubkey(),
        collection_pda: collection_info.pda,
        payer: formfn_authority.pubkey(),
        system_program: system_program::id(),
        rent: sysvar::rent::id(),
    ...
    let data = formfn_candy_machine::instruction::SetCollection {}.data();
...
pub async fn remove_collection(
    ...
    let accounts = formfn_candy_machine::accounts::RemoveCollection {
        candy_machine: *candy_machine,
        formfn_authority: formfn_authority.pubkey(),
        collection_pda: collection_info.pda,
        metadata: collection_info.metadata,
    ...
    let data = formfn_candy_machine::instruction::RemoveCollection {}.data();
    let set_ix = Instruction {
        program_id: formfn_candy_machine::id(),
        data,
        accounts,
...
pub async fn set_freeze(
    ...
    let mut accounts = formfn_candy_machine::accounts::SetFreeze {
        candy_machine: *candy_machine,
    ...
    let data = formfn_candy_machine::instruction::SetFreeze {
...
pub async fn remove_freeze(
    ...
    let accounts = formfn_candy_machine::accounts::RemoveFreeze {
        candy_machine: *candy_machine,
        formfn_authority: formfn_authority.pubkey(),
        freeze_pda: freeze_info.pda,
    }
    ...
    let data = formfn_candy_machine::instruction::RemoveFreeze {}.data();
    let set_ix = Instruction {
        program_id: formfn_candy_machine::id(),
        data,
        accounts,
...
pub async fn thaw_nft(
    ...
    let accounts = formfn_candy_machine::accounts::ThawNFT {
        freeze_pda: freeze_info.pda,
        candy_machine: *candy_machine,
    ...
    let data = formfn_candy_machine::instruction::ThawNft {}.data();
    let set_ix = Instruction {
        program_id: formfn_candy_machine::id(),
        data,
        accounts,
...
pub async fn unlock_funds(
    ...
    let mut accounts = formfn_candy_machine::accounts::UnlockFunds {
        freeze_pda: freeze_info.pda,
        candy_machine: *candy_machine,
        formfn_authority: formfn_authority.pubkey(),
        system_program: system_program::id(),
    ...
    let data = formfn_candy_machine::instruction::UnlockFunds {}.data();
    let set_ix = Instruction {
        program_id: formfn_candy_machine::id(),
        data,
        accounts,
...
pub fn mint_nft_ix(
    ...
    let mut accounts = formfn_candy_machine::accounts::MintNFT {
        candy_machine: *candy_machine,
    ...
    let data = formfn_candy_machine::instruction::MintNft {
        creator_bump,
    ...
    if collection_info.set {
        let accounts = formfn_candy_machine::accounts::SetCollectionDuringMint {
            candy_machine: *candy_machine,
            metadata,
            buyer: buyer.pubkey(),
            collection_pda: collection_info.pda,
        ...
        .to_account_metas(None);
        let data = formfn_candy_machine::instruction::SetCollectionDuringMint {}.data();
        let set_ix = Instruction {
            program_id: formfn_candy_machine::id(),
            data,
            accounts,
