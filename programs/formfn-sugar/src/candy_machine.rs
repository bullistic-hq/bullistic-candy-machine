...
pub use formfn_candy_machine::ID as CANDY_MACHINE_ID;
...
// To test a custom candy machine program, comment the formfn_candy_machine::ID line
...
pub fn print_candy_machine_state(state: CandyMachine) {
    println!("Authority {:?}", state.formfn_authority);
