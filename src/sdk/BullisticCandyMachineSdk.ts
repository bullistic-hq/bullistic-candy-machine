...
import { CandyMachineProgram, BULLISTIC_CANDY_MACHINE_IDL } from "sdk/idl";
import { BullisticCandyMachine } from "sdk/idl/BullisticCandyMachine";
...
export default class BullisticCandyMachineSdk {
  private _connection: Connection;
  private _idl: Idl = BULLISTIC_CANDY_MACHINE_IDL;
  ...
  constructor({
    ...
    this._program = new Program<BullisticCandyMachine>(
      BULLISTIC_CANDY_MACHINE_IDL,
